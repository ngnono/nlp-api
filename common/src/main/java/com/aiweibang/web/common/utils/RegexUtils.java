package com.aiweibang.web.common.utils;
...
public class RegexUtils {
    ...
    public final static Pattern DATE_PATTERN = Pattern.compile(DATE_PATTERN_STRING);
    ...
    public static boolean isMatch(String desc, String regex) {
        if (org.apache.commons.lang.StringUtils.isEmpty(desc) || org.apache.commons.lang.StringUtils.isEmpty(regex)) {
            return false;
        }
    ...
    public static String removeRepeatChar(String source) {
        source = org.apache.commons.lang.StringUtils.trimToEmpty(source);
    ...
    public static int removeRepeatCharCount(String source) {
        source = org.apache.commons.lang.StringUtils.trimToEmpty(source);
        if (org.apache.commons.lang.StringUtils.isNotBlank(source)) {
            return org.apache.commons.lang.StringUtils.length(source.replaceAll("(?s)(.)(?=.*\\1)", ""));
        } else {
            return 0;
        }
    }
    ...
    public static boolean isRepeatChar(String str, float rate) {
        ...
        int len = org.apache.commons.lang.StringUtils.length(str);
    ...
    public static void main(String[] args) {
        String date = "2016-03-30 21:31:48.820";
